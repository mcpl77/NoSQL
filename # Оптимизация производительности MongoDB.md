...
- Возникала нехватка памяти из-за докера, в связи с чем периодически отпадала связь в базой данных и не было возможности проводит манипуляции по части шардов и пользователей.